...
def test_trivia_calculate_scores_correct(mocker):
    ...
    app.TABLE.update_item.assert_called_with(
        ...
        AttributeUpdates={'score': {'Value': 30, 'Action': 'PUT'}}
    )

    app.MANAGEMENT.post_to_connection.assert_has_calls([
        mock.call(Data='{"action": "playerlist", "players": [{"connectionId": "connection-1", "playerName": "AliceBlue", "score": 30, "currentPlayer": true}]}', ConnectionId='connection-1'),
